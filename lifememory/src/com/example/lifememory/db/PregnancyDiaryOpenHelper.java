...
public class PregnancyDiaryOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		 ...
		 * noticeValue  警戒线金额
		 */
		db.execSQL("create table if not exists bill_info(idx integer primary key autoincrement, jine text, incatagory text, outcatagory text , account text, date text, dateymd text, member text, beizhu text, isCanBaoXiao text, isBaoxiaoed text, transferIn text, transferOut text, billType integer)");
